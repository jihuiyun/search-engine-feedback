...
- 打开搜索引擎，网址：https://www.sogou.com/；
- 输入关键词搜索；
- 依次点击每个搜索结果，判断是否过期信息，如果过期则将搜索结果的链接复制到反馈站点 https://fankui.sogou.com/index.php/web/web/index?type=2 网页快照地址中；
- 打开反馈站点 https://fankui.sogou.com/index.php/web/web/index?type=2
    - 问题类型选择「删除快照」
    - 网页快照地址
    - 原因描述：「网页打不开，提示内容已删除或找不到该网页，请删除快照，且快照包含91y关键词信息为不实内容，误导91y游戏用户，已严重影响到浮云公司的商誉和正常的经营秩序」
    - 申请人类型：单位/公司
    - 有效资料上传：依次上传配置文件里的jpg格式的照片
    - 联系方式：邮箱
    - 邮箱填写：huiyun@fuyuncn.com
    - 验证码需要人工识别
    - 验证码通过验证后点击「提交」。
